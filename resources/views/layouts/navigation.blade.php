                ...
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex items-center">
                          ...
                          <x-dropdown placement="bottom-center" width="w-52">
                            <x-slot name="trigger">
                              <button class="flex items-center text-gray-200 hover:text-gray-700 hover:bg-indigo-200 hover:border-gray-300 focus:outline-none focus:bg-indigo-300 focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out bg-indigo-700 px-3 py-1.5 rounded-lg">
                            ...
                            <x-slot name="content">
                              <article class="grid grid-cols-2 gap-2 px-2 text-indigo-700">
                                <x-dropdown-link modal :href="route('projects.create')">
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                ...
                                <x-dropdown-link modal :href="route('customers.create')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                ...
                                <x-dropdown-link modal :href="route('companies.create')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                ...
                                {{-- <x-dropdown-link modal :href="route('contracts.create')">
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
