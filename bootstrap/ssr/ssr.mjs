...
import { registerRuntimeCompiler, initCustomFormatter, warn, ref, computed, defineComponent, h as h$1, Fragment, onMounted, watch, onUnmounted, provide, inject, watchEffect, Teleport, reactive, unref, nextTick, cloneVNode, openBlock, createBlock, createCommentVNode, createElementBlock, normalizeStyle, KeepAlive, createVNode, renderList, onBeforeUnmount, renderSlot, withModifiers, createElementVNode, resolveComponent, withCtx, normalizeProps, mergeProps, createSSRApp } from "@vue/runtime-dom";
...
D[gs] = D[ys] = D[bs] = D[ws] = D[Ss] = D[Os] = D[$s] = D[Es] = D[_s] = true;
D[rs] = D[ns] = D[ms] = D[is] = D[vs] = D[as] = D[ss] = D[os] = D[ls] = D[us] = D[cs] = D[fs] = D[ds] = D[ps] = D[hs] = false;
function xs(e) {
...
const Ct = ref(0), fr = ref(1), L = ref({}), le = ref(0), $e = typeof window > "u";
function Js(e, t, r) {
...
function ro(e, t) {
  ...
  if (e.data.splade.lazy)
    return;
  if (e.data.splade.modal && le.value++, Br(e.data.splade), Rt(e.data.splade.head), r === L.value.url && (t = true), e.data.splade.modal)
...
const pi = ref({}), hi = (e) => pi.value[e], io = (e) => Object.keys(hi.value[e]).length > 0, mi = ref({}), ao = (e) => mi.value[e], vi = ref({}), so = (e) => vi.value[e], We = ref([]);
function oo(e) {
  We.value.push(e);
}
const lo = computed(() => Ys(We.value));
function uo(e) {
...
const oe = {
  ...
  setup(e) {
    const t = e;
    provide("stack", 0);
    const r = ref(), n = ref([]), i = ref(null), a = inject("$spladeOptions") || {}, s = computed(() => h.currentStack.value < 1 ? [] : {
      filter: "blur(4px)",
    ...
    return h.setOnHead((f) => {
      ...
      i.value = f;
    }), h.init(t.initialHtml, t.initialDynamics, t.initialSpladeData), (f, p) => (openBlock(), createElementBlock("div", null, [
      unref(h).isSsr ? (openBlock(), createBlock(oe, {
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(h).currentStack.value, (d) => (openBlock(), createBlock(oe, {
        key: `modal.${d}`,
        type: n.value[d].type,
        html: n.value[d].html,
        stack: d,
        "on-top-of-stack": unref(h).currentStack.value === d,
        onClose: (v) => l(d)
      }, null, 8, ["type", "html", "stack", "on-top-of-stack", "onClose"]))), 128)),
      i.value ? (openBlock(), createBlock($o, {
        key: 2,
        html: i.value,
        onClose: o
...
function Fr(e, t) {
  if (F(e))
    return false;
  var r = typeof e;
  return r == "number" || r == "symbol" || r == "boolean" || e == null || Mt(e) ? true : Po.test(e) || !Io.test(e) || t != null && e in Object(t);
}
...
function al(e) {
  ...
  if (r < 0)
    return false;
  var n = t.length - 1;
  return r == n ? t.pop() : il.call(t, r, 1), --this.size, true;
}
function sl(e) {
  var t = this.__data__, r = Nt(t, e);
...
function z({ visible: e = true, features: t = 0, ourProps: r, theirProps: n, ...i }) {
  ...
  if (t & 1) {
    ...
    return Y(l, { [0]() {
      ...
      return ir({ ...i, props: { ...s, hidden: true, style: { display: "none" } } });
    } });
  }
  return ir(o);
}
...
`));
  ...
  return h$1(s, Object.assign({}, o, u), l);
}
function Ti(e) {
  return e.flatMap((t) => t.type === Fragment ? Ti(t.children) : [t]);
}
function _l(...e) {
  if (e.length === 0)
    return {};
...
function ql(e, t = 0) {
  var r;
  return e === ((r = Ye(e)) == null ? void 0 : r.body) ? false : Y(t, { [0]() {
    return e.matches(dr);
  }, [1]() {
    let n = e;
    for (; n !== null; ) {
...
function pr(e, t, r = true, n = null) {
  ...
  let o = (() => {
    ...
    if (t & 8)
      return s.length - 1;
    throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
  })(), u = t & 32 ? { preventScroll: true } : {}, c = 0, f = s.length, p;
  do {
    if (c >= f || c + f <= 0)
      return 0;
    let d = l + c;
...
function kl(e, t, r = computed(() => true)) {
  function n(a, s) {
  ...
  }, true), ar("blur", (a) => n(a, () => window.document.activeElement instanceof HTMLIFrameElement ? window.document.activeElement : null), true);
}
var qt = ((e) => (e[e.None = 1] = "None", e[e.Focusable = 2] = "Focusable", e[e.Hidden = 4] = "Hidden", e))(qt || {});
let hr = defineComponent({ name: "Hidden", props: { as: { type: [Object, String], default: "div" }, features: { type: Number, default: 1 } }, setup(e, { slots: t, attrs: r }) {
  return () => {
...
let nt = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: Object, default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  ...
  n({ el: i, $el: i });
  let a = computed(() => Ye(i));
  Nl({ ownerDocument: a }, computed(() => Boolean(e.features & 16)));
  let s = Vl({ ownerDocument: a, container: i, initialFocus: computed(() => e.initialFocus) }, computed(() => Boolean(e.features & 2)));
  Hl({ ownerDocument: a, container: i, containers: e.containers, previousActiveElement: s }, computed(() => Boolean(e.features & 8)));
  let o = Rl();
  function l() {
    let u = pe(i);
  ...
  return () => {
    ...
    return h$1(Fragment, [Boolean(f & 4) && h$1(hr, { as: "button", type: "button", onFocus: l, features: qt.Focusable }), z({ ourProps: c, theirProps: { ...t, ...v }, slot: u, attrs: t, slots: r, name: "FocusTrap" }), Boolean(f & 4) && h$1(hr, { as: "button", type: "button", onFocus: l, features: qt.Focusable })]);
  };
} }), { features: ji });
...
function zl() {
  return inject(Li, false);
}
let vr = defineComponent({ name: "ForcePortalRoot", props: { as: { type: [Object, String], default: "template" }, force: { type: Boolean, default: false } }, setup(e, { slots: t, attrs: r }) {
  return provide(Li, e.force), () => {
    let { force: n, ...i } = e;
...
let Bi = defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e, { slots: t, attrs: r }) {
  let n = ref(null), i = computed(() => Ye(n)), a = zl(), s = inject(ki, null), o = ref(a === true || s == null ? Gl(n.value) : s.resolveTarget());
  return watchEffect(() => {
    ...
    return h$1(Teleport, { to: o.value }, z({ ourProps: l, theirProps: e, slot: {}, attrs: r, slots: t, name: "Portal" }));
  };
} }), ki = Symbol("PortalGroupContext"), Kl = defineComponent({ name: "PortalGroup", props: { as: { type: [Object, String], default: "template" }, target: { type: Object, default: null } }, setup(e, { attrs: t, slots: r }) {
...
function Yl() {
  let e = inject(Ri, null);
  if (e === null)
    throw new Error("Missing parent");
  return e;
}
function Jl({ slot: e = ref({}), name: t = "Description", props: r = {} } = {}) {
  let n = ref([]);
  function i(a) {
  ...
  return provide(Ri, { register: i, slot: e, name: t, props: r }), computed(() => n.value.length > 0 ? n.value.join(" ") : void 0);
}
defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" } }, setup(e, { attrs: t, slots: r }) {
  ...
  return onMounted(() => onUnmounted(n.register(i))), () => {
    let { name: a = "Description", slot: s = ref({}), props: o = {} } = n, l = e, u = { ...Object.entries(o).reduce((c, [f, p]) => Object.assign(c, { [f]: unref(p) }), {}), id: i };
...
let $t = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Wr = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: $t }, initialFocus: { type: Object, default: null } }, emits: { close: (e) => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  var a;
  let s = ref(false);
  onMounted(() => {
    s.value = true;
  });
  let o = ref(0), l = Hr(), u = computed(() => e.open === $t && l !== null ? Y(l.value, { [ke.Open]: true, [ke.Closed]: false }) : e.open), c = ref(/* @__PURE__ */ new Set()), f = ref(null), p = ref(null), d = computed(() => Ye(f));
  ...
  let v = computed(() => s.value && u.value ? 0 : 1), b = computed(() => v.value === 0), w = computed(() => o.value > 1), T = inject(yr, null) !== null, A = computed(() => w.value ? "parent" : "leaf");
  Wl(f, computed(() => w.value ? b.value : false)), Ql({ type: "Dialog", enabled: computed(() => v.value === 0), element: f, onUpdate: (g, S, _) => {
    if (S === "Dialog")
      return Y(g, { [gr.Add]() {
  ...
  let I = Jl({ name: "DialogDescription", slot: computed(() => ({ open: u.value })) }), E = `headlessui-dialog-${Ne()}`, O = ref(null), m = { titleId: O, panelRef: ref(null), dialogState: v, setTitleId(g) {
    O.value !== g && (O.value = g);
  }, close() {
    t("close", false);
  } };
  return provide(yr, m), kl(() => {
    var g, S, _;
    ...
    m.close(), nextTick(() => S == null ? void 0 : S.focus());
  }, computed(() => v.value === 0 && !w.value)), qi((a = d.value) == null ? void 0 : a.defaultView, "keydown", (g) => {
    ...
    if ($(C, "overflow", "hidden"), j > 0) {
      let B = C.clientWidth - C.offsetWidth, V = j - B;
      $(C, "paddingRight", `${V}px`);
    }
    if (Zl()) {
    ...
    let g = { ...r, ref: f, id: E, role: "dialog", "aria-modal": v.value === 0 ? true : void 0, "aria-labelledby": O.value, "aria-describedby": I.value }, { open: S, initialFocus: _, ...x } = e, $ = { open: v.value === 0 };
    return h$1(vr, { force: true }, () => [h$1(Bi, () => h$1(Kl, { target: f.value }, () => h$1(vr, { force: false }, () => h$1(nt, { initialFocus: _, containers: c, features: b.value ? Y(A.value, { parent: nt.features.RestoreFocus, leaf: nt.features.All & ~nt.features.FocusLock }) : nt.features.None }, () => z({ ourProps: g, theirProps: x, slot: $, attrs: r, slots: n, visible: v.value === 0, features: Dt.RenderStrategy | Dt.Static, name: "Dialog" }))))), h$1(hr, { features: qt.Hidden, ref: p })]);
  };
} });
...
defineComponent({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  let i = ht("DialogBackdrop"), a = `headlessui-dialog-backdrop-${Ne()}`, s = ref(null);
  return n({ el: s, $el: s }), onMounted(() => {
    if (i.panelRef.value === null)
      throw new Error("A <DialogBackdrop /> component is being used, but a <DialogPanel /> component is missing.");
  }), () => {
    let o = e, l = { id: a, ref: s, "aria-hidden": true };
    return h$1(vr, { force: true }, () => h$1(Bi, () => z({ ourProps: l, theirProps: { ...t, ...o }, slot: { open: i.dialogState.value === 0 }, attrs: t, slots: r, name: "DialogBackdrop" })));
  };
} });
let zr = defineComponent({ name: "DialogPanel", props: { as: { type: [Object, String], default: "div" } }, setup(e, { attrs: t, slots: r, expose: n }) {
...
function iu() {
  return inject(Gr, null) !== null;
}
function au() {
  let e = inject(Gr, null);
  if (e === null)
...
let Ni = Dt.RenderStrategy, Je = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  if (!iu() && Il())
    return () => h$1(Ze, { ...e, onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave") }, n);
  let a = ref(null), s = ref("visible"), o = computed(() => e.unmount ? we.Unmount : we.Hidden);
  i({ el: a, $el: a });
  let { show: l, appear: u } = au(), { register: c, unregister: f } = su(), p = { value: true }, d = Ne(), v = { value: false }, b = Mi(() => {
  ...
  function g(S) {
    ...
    !x || !(x instanceof HTMLElement) || _ || (v.value = true, l.value && t("beforeEnter"), l.value || t("beforeLeave"), S(l.value ? _n(x, w, T, A, I, ($) => {
      v.value = false, $ === br.Finished && t("afterEnter");
    }) : _n(x, E, O, m, I, ($) => {
      v.value = false, $ === br.Finished && (Wt(b) || (s.value = "hidden", f(d), t("afterLeave")));
    })));
  }
  return onMounted(() => {
    watch([l], (S, _, x) => {
  ...
  }), provide(Kr, b), Pl(computed(() => Y(s.value, { visible: ke.Open, hidden: ke.Closed }))), () => {
    let { appear: S, show: _, enter: x, enterFrom: $, enterTo: C, entered: j, leave: B, leaveFrom: V, leaveTo: R, ...M } = e;
    return z({ theirProps: M, ourProps: { ref: a }, slot: {}, slots: n, attrs: r, features: Ni, visible: s.value === "visible", name: "TransitionChild" });
  };
} }), ou = Je, Ze = defineComponent({ inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n }) {
  let i = Hr(), a = computed(() => e.show === null && i !== null ? Y(i.value, { [ke.Open]: true, [ke.Closed]: false }) : e.show);
  watchEffect(() => {
    if (![true, false].includes(a.value))
      throw new Error('A <Transition /> is used but it is missing a `:show="true | false"` prop.');
  });
  let s = ref(a.value ? "visible" : "hidden"), o = Mi(() => {
    s.value = "hidden";
  }), l = ref(true), u = { show: a, appear: computed(() => e.appear || !l.value) };
  return onMounted(() => {
    watchEffect(() => {
      l.value = false, a.value ? s.value = "visible" : Wt(o) || (s.value = "hidden");
    });
  }), provide(Kr, o), provide(Gr, u), () => {
    let c = Ai(e, ["show", "appear", "unmount", "onBeforeEnter", "onBeforeLeave", "onAfterEnter", "onAfterLeave"]), f = { unmount: e.unmount };
    return z({ ourProps: { ...f, as: "template" }, theirProps: {}, slot: {}, slots: { ...n, default: () => [h$1(ou, { onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave"), ...r, ...f, ...c }, n.default)] }, attrs: {}, features: Ni, visible: s.value === "visible", name: "Transition" });
  };
} });
const lu = {
  props: {
  ...
  methods: {
    cancel() {
      h.confirmModal.value.rejectPromise(), this.setIsOpen(false);
    },
    confirm() {
      h.confirmModal.value.resolvePromise(), this.setIsOpen(false);
    },
    setIsOpen(e) {
      this.isOpen = e;
    },
...
function Qr(e, t, r) {
  var n, i, a, s, o, l, u = 0, c = false, f = false, p = true;
...
function Du(e, t, r) {
  ...
  return (n || !n && !r) && ((ie(t) !== "body" || en(a)) && (o = Pu(t)), X(t) ? (l = Ge(t, true), l.x += t.clientLeft, l.y += t.clientTop) : a && (l.x = Zr(a))), {
...
function tn(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, i = n === void 0 ? e.placement : n, a = r.strategy, s = a === void 0 ? e.strategy : a, o = r.boundary, l = o === void 0 ? Lu : o, u = r.rootBoundary, c = u === void 0 ? Xi : u, f = r.elementContext, p = f === void 0 ? it : f, d = r.altBoundary, v = d === void 0 ? false : d, b = r.padding, w = b === void 0 ? 0 : b, T = sc(typeof w != "number" ? w : oc(w, Xt)), A = p === it ? Bu : it, I = e.rects.popper, E = e.elements[v ? A : p], O = ac(Fe(E) ? E : E.contextElement || Te(e.elements.popper), l, c, s), m = Ge(e.elements.reference), g = Yi({
    reference: m,
    element: I,
    strategy: "absolute",
    placement: i
  ...
  if (p === it && $) {
    ...
    Object.keys(x).forEach(function(j) {
      var B = [Ee, ae].indexOf(j) >= 0 ? 1 : -1, V = [J, ae].indexOf(j) >= 0 ? "y" : "x";
      x[j] += C[V] * B;
    });
  }
  return x;
...
function Ln(e) {
  ...
  if (d = C.x, b = C.y, l) {
    var j;
    return Object.assign({}, $, (j = {}, j[E] = A ? "0" : "", j[I] = T ? "0" : "", j.transform = (O.devicePixelRatio || 1) <= 1 ? "translate(" + d + "px, " + b + "px)" : "translate3d(" + d + "px, " + b + "px, 0)", j));
  }
...
function _c(e) {
  var t = e.state, r = e.options, n = e.name, i = r.mainAxis, a = i === void 0 ? true : i, s = r.altAxis, o = s === void 0 ? false : s, l = r.boundary, u = r.rootBoundary, c = r.altBoundary, f = r.padding, p = r.tether, d = p === void 0 ? true : p, v = r.tetherOffset, b = v === void 0 ? 0 : v, w = tn(t, {
    boundary: l,
    rootBoundary: u,
    padding: f,
    altBoundary: c
  ...
  if (!!m) {
    if (a) {
      var j, B = E === "y" ? J : ue, V = E === "y" ? ae : Ee, R = E === "y" ? "height" : "width", M = m[E], vt = M + w[B], Ae = M - w[V], gt = d ? -S[R] / 2 : 0, Yt = A === Ke ? g[R] : S[R], et = A === Ke ? -S[R] : -g[R], yt = t.elements.arrow, He = d && yt ? Gi(yt) : {
        width: 0,
        height: 0
...
function Cc(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var i = r.mainAxis, a = i === void 0 ? true : i, s = r.altAxis, o = s === void 0 ? true : s, l = r.fallbackPlacements, u = r.padding, c = r.boundary, f = r.rootBoundary, p = r.altBoundary, d = r.flipVariations, v = d === void 0 ? true : d, b = r.allowedAutoPlacements, w = t.options.placement, T = ce(w), A = T === w, I = l || (A || !v ? [It(w)] : Pc(w)), E = [w].concat(I).reduce(function(He, ve) {
    ...
    }, []), O = t.rects.reference, m = t.rects.popper, g = /* @__PURE__ */ new Map(), S = true, _ = E[0], x = 0; x < E.length; x++) {
      var $ = E[x], C = ce($), j = Xe($) === Ke, B = [J, ae].indexOf(C) >= 0, V = B ? "width" : "height", R = tn(t, {
        placement: $,
        boundary: c,
        rootBoundary: f,
        altBoundary: p,
...
const Bc = /* @__PURE__ */ Ve(qc, [["render", Lc]]), kc = {
  __name: "DynamicHtml",
  props: {
    keepAliveKey: {
      type: String,
...
function Vc(e, t, r, n, i, a) {
  return openBlock(), createElementBlock("div", Nc, [
    renderSlot(e.$slots, "default", {
...
function na(e, t, r, n, i, a) {
  ...
  if (u && c)
    return u == t && c == e;
  var f = -1, p = true, d = r & nf ? new Lt() : void 0;
...
function Wf(e, t, r, n, i, a) {
  ...
  return p ? (a || (a = new fe()), Df(e, t, r, n, i, a)) : false;
}
function Qt(e, t, r, n, i) {
  return e === t ? true : e == null || t == null || !Oe(e) && !Oe(t) ? e !== e && t !== t : Wf(e, t, r, n, Qt, i);
}
var zf = 1, Gf = 2;
function Kf(e, t, r, n) {
...
function la(e) {
  return e === true || e === false || Oe(e) && xe(e) == dd;
}
function ua(e, t) {
  var r = {};
...
`));
  ...
  mounted() {
    ...
    }, { deep: true }) : F(this.submitOnChange) && this.submitOnChange.forEach((t) => {
      this.$watch(`values.${t}`, () => {
        this.$nextTick(() => this.request());
      }, { deep: true });
    });
  ...
  methods: {
    ...
    initChoices(e) {
      ...
      import("choices.js").then((n) => {
        ...
        }, document.querySelector("#headlessui-portal-root").addEventListener("click", r.headlessListener, { capture: true })), this.choicesInstance.containerInner.element.setAttribute(
          "data-select-name",
          e.name
        ), e.hasAttribute("dusk")) {
...
function Td(e, t, r, n, i, a) {
  return openBlock(), createElementBlock("div", xd, [
    renderSlot(e.$slots, "default")
  ], 512);
}
...
const qd = {
  ...
  methods: {
    ...
    toggleColumn(e) {
      const t = !this.columnIsVisible(e), r = Dd(this.columns, (i) => i.can_be_hidden ? i.key === e ? t : this.visibleColumns.includes(i.key) : true);
      let n = ca(r, (i) => i.key).sort();
      Yn(n, this.defaultVisibleToggleableColumns) && (n = []), this.visibleColumns = n.length === 0 ? this.defaultVisibleToggleableColumns : n, this.updateQuery("columns", n, null, false);
    },
    ...
    async performBulkAction(e, t, r, n, i) {
      if (t)
        try {
          await h.confirm(t === true ? "" : t, r, n, i);
        } catch {
          return false;
        }
      this.isLoading = true, h.request(e, "POST", { ids: this.selectedItems }, {}, false).then((a) => {
        a.data;
      }).catch(() => {
...
const Bd = /* @__PURE__ */ Ve(jd, [["render", Ld]]), kd = {
  props: {
    autosize: {
      type: Boolean,
      required: false,
